...
── Joints del robot ──────────────────────────────
  [0] Cube.001_link_joint                       tipo=4
  [1] Cube.002_link_joint                       tipo=4
  [2] base_link_joint                           tipo=4
  [3] link1_link_joint                          tipo=4
  [4] link2_link_joint                          tipo=0
  [5] link3_link_joint                          tipo=0
  [6] rot_link4_link_joint                      tipo=0
  [7] pris_link4_link_joint                     tipo=1
  [8] pris_link4.001_link_joint                 tipo=1
  [9] pris_link4.002_link_joint                 tipo=1
  [10] Cube_link_joint                           tipo=4
  [11] axisB_link_joint                          tipo=4
  [12] armBackL_link_joint                       tipo=4
  [13] backL_link_joint                          tipo=0
  [14] armBackR_link_joint                       tipo=4
  [15] backR_link_joint                          tipo=0
  [16] axisF_link_joint                          tipo=4
  [17] armFrontR_link_joint                      tipo=4
  [18] frontR_link_joint                         tipo=0
  [19] armFrontL_link_joint                      tipo=4
  [20] frontL_link_joint                         tipo=0
─────────────────────────────────────────────────
"""
